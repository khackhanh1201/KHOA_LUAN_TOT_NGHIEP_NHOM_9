...
public interface TaxExemptSubjectRepository extends JpaRepository<TaxExemptSubjectEntity, Integer> {
    ...
    Optional<TaxExemptSubjectEntity> findFirstByCitizenIdAndAppliedYearOrderByExemptIdDesc(
            Integer citizenId, Integer appliedYear);

    java.util.List<TaxExemptSubjectEntity> findAllByCitizenIdAndAppliedYearOrderByExemptIdDesc(
            Integer citizenId, Integer appliedYear);
