    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Các API công khai
                .requestMatchers("/api/public/**", "/api/auth/**", "/api/payments/webhook", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/api/profile/sync", "/api/land-prices/lookup", "/api/lands/**", "/error").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/land-parcels/by-gcn", "/api/land-parcels/*/owners")
                        .hasAnyAuthority("ROLE_LAND_OFFICER", "ROLE_ADMIN", "ROLE_TAX_OFFICER")
                .requestMatchers(HttpMethod.GET, "/api/land-parcels/lookup-unowned",
                        "/api/land-parcels/lookup-by-gcn")
                        .hasAuthority("ROLE_CITIZEN")
                .requestMatchers("/api/land-parcels/**").hasAnyAuthority("ROLE_LAND_OFFICER", "ROLE_ADMIN", "ROLE_CITIZEN", "ROLE_TAX_OFFICER")
                .requestMatchers("/api/tax/**").hasAnyAuthority("ROLE_TAX_OFFICER", "ROLE_ADMIN", "ROLE_CITIZEN", "ROLE_LAND_OFFICER")
                .requestMatchers("/api/mutation-requests/**").hasAnyAuthority("ROLE_CITIZEN", "ROLE_LAND_OFFICER", "ROLE_ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/payments/by-record/**").hasAnyAuthority("ROLE_LAND_OFFICER", "ROLE_TAX_OFFICER", "ROLE_ADMIN", "ROLE_CITIZEN")
                .requestMatchers("/api/payments/**", "/api/profile/**").hasAnyAuthority("ROLE_CITIZEN", "ROLE_TAX_OFFICER", "ROLE_LAND_OFFICER", "ROLE_ADMIN")
