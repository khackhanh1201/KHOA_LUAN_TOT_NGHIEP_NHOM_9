...
import {
  ...
  notiViewAllBtnStyle,
} from './cadastralLayoutStyles';

const CadastralNotificationPanel = ({
  notiRef,
  notiOpen,
  onToggle,
  unreadCount,
    ...
    {notiOpen && (
      <div style={notiPanelStyle}>
        ...
        <div style={notiPanelFooterStyle}>
          <button type="button" onClick={() => onNavigate('/dashboard')} style={notiViewAllBtnStyle}>
            Xem bảng điều khiển
          </button>
        </div>
      </div>
...
export default CadastralNotificationPanel;
