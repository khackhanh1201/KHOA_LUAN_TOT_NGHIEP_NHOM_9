...
const TaxOfficerSwitchRoleModal = ({
  displayName,
  userRoles,
  activeRole,
  onClose,
    ...
    <div style={styles.modalContent}>
      <div style={styles.modalHeader}>
        ...
        <button type="button" style={styles.modalCloseBtn} onClick={onClose} aria-label="Đóng">
          <i className="bi bi-x" style={{ fontSize: 22 }} />
        </button>
      </div>
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 13, color: '#94a3b8' }}>{ROLE_LABELS[role] || role}</div>
              </div>
              {isActive && (
                <div style={styles.checkmark}>
                  <i className="bi bi-check-lg" style={{ fontSize: 16, color: '#fff' }} />
                </div>
              )}
            </button>
          );
...
export default TaxOfficerSwitchRoleModal;
